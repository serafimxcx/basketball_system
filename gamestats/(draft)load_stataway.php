<?php
    ...
    $query = "select CONCAT(tb_players.last_name, ', ', tb_players.first_name) as playername, tb_players.img_source, tb_gamestats.points, tb_gamestats.rebounds, tb_gamestats.assists, tb_gamestats.blocks, tb_gamestats.steals, tb_gamestats.fouls, tb_gamestats.three_pts, tb_gamestats.free_throw, tb_gamestats.isInjured, tb_teams.team_name, tb_teams.coach_id, tb_players.player_number, tb_players.player_id, tb_gamestats.gamestats_id
    from tb_players, tb_gamesched, tb_gamestats, tb_coach, tb_teams
    where tb_gamestats.gamesched_id = '".intval($_REQUEST['sched_id'])."' and tb_gamesched.gamesched_id = '".intval($_REQUEST['sched_id'])."' and tb_gamestats.player_id = tb_players.player_id and tb_players.team_id = tb_gamesched.awayteam_id and tb_gamesched.awayteam_id = tb_teams.team_id and tb_teams.coach_id = tb_coach.coach_id
