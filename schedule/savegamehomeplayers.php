<?php 
    ...
    while($row = mysqli_fetch_assoc($resultID)){
        ...
        foreach($playerStatus as $player){
            ...
            $query = "insert into tb_gameplayers (gamesched_id, team_id, player_id, position_id, isFirstfive, isInjured) values($gameschedID, $homeTeam, $playerId, $selectedPosition, $isFirstFive, $isInjured)";
